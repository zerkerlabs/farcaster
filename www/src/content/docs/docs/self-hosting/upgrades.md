...
Because [migrations run automatically at startup](/docs/self-hosting/postgres/),
...
An upgrade must keep the **same [`FARCASTER_KMS_KEY`](/docs/self-hosting/kms-and-secrets/)**
