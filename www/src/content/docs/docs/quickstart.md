...
Start the gateway first — see [Install](/docs/install/). Everything below
...
[Sovereignty & no-custody](/docs/concepts/sovereignty/) for why that matters,
and [OSS vs Commercial at a glance](/docs/oss-vs-commercial/) for what happens
