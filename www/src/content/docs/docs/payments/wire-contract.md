...
schema — see [Architecture](/docs/concepts/architecture/) — so this page
...
[API reference](/docs/api-reference/x402/).
...
[Gate vs settle](/docs/payments/gate-vs-settle/) for what happens next.
...
[Endpoints](/docs/facilitator/endpoints/) for how `/settle` uses it.
...
transfer itself; see [Custody posture](/docs/facilitator/custody/).
...
is in the [x402 wire-contract reference](/docs/api-reference/x402/), rendered
